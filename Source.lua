...
Spawner.runEntity = function(entityTable)
    ...
    if entityTable.Config.LightColor[1] then
        ModuleScripts.ModuleEvents.colorLights(workspace.CurrentRooms[ReSt.GameData.LatestRoom.Value], entityTable.Config.ColorLights[2])
    end
